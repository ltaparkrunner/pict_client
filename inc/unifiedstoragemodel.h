...
public:
    ...
    Q_INVOKABLE void enterServerStore(QString path);        // Зайти в список бакетов MinIO
//    Q_INVOKABLE void enterServerStore2(const QString &path);        // Зайти в список бакетов MinIO
